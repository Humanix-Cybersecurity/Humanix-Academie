...
const LEVEL_BG: Record<string, string> = {
  ...
  jaune:
    "bg-amber-50 dark:bg-amber-900/20 border-amber-300 text-amber-800 dark:text-amber-200",
  orange:
    "bg-orange-50 dark:bg-orange-900/20 border-orange-300 text-orange-800 dark:text-orange-200",
  rouge:
    "bg-red-50 dark:bg-red-900/20 border-red-400 text-red-900 dark:text-red-200",
};
  ...
  return (
    <div className={`rounded-2xl border-2 p-5 ${cls}`}>
      <div className="flex items-start justify-between gap-3 mb-2">
        ...
        <div className="text-right text-[10px] opacity-70">
          ...
          <p className="font-mono">
            {new Date(meteo.computedAt).toLocaleString("fr-FR", {
              dateStyle: "short",
              timeStyle: "short",
            })}
          </p>
      ...
      <p className="text-[10px] opacity-60 mt-3 italic">
        Source : flux officiel CERT-FR · cert.ssi.gouv.fr · données mises en
        cache 1 h
      </p>
    </div>
  );
