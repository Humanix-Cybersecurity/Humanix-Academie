...
export function deriveRemediationPlan(input: ExposureInput): RemediationItem[] {
  ...
  if (input.passwordPwned) {
    items.push({
      ...
      label:
        "Changer ce mot de passe partout, avec un mot de passe unique par site",
    ...
    items.push({
      ...
      priority: 1,
      sourceUrl:
        "https://www.cybermalveillance.gouv.fr/tous-nos-contenus/bonnes-pratiques/gestionnaires-de-mots-de-passe",
      sourceLabel: "cybermalveillance.gouv.fr",
      episodeSlug: E("01-mot-de-passe-compromis"),
    });
  }
  ...
  items.push({
    ...
    sourceUrl:
      "https://www.cybermalveillance.gouv.fr/tous-nos-contenus/bonnes-pratiques/securiser-ses-comptes-double-authentification",
    sourceLabel: "cybermalveillance.gouv.fr",
  ...
  if (input.domainBreaches > 0) {
    items.push({
      ...
      label:
        "Surveiller les comptes liés à ton organisation et signaler tout accès suspect",
  ...
  if (input.sensitiveDataInBreaches) {
    items.push({
      ...
      priority: 1,
      sourceUrl:
        "https://www.cybermalveillance.gouv.fr/tous-nos-contenus/bonnes-pratiques/fraude-carte-bancaire",
      sourceLabel: "cybermalveillance.gouv.fr",
  ...
  items.push({
    ...
    priority: 3,
    sourceUrl:
      "https://www.cnil.fr/fr/cnil-direct/question/proteger-mon-adresse-electronique",
    sourceLabel: "CNIL",
  ...
  items.push({
    ...
    label:
      "Demander l'effacement de tes données aux courtiers (droit RGPD art. 17)",
