...
const CATEGORIE_PROFILS: Record<
  string,
  {
    ...
    choices: { id: string; label: string; outcome: "good" | "bad" | "neutral"; feedback: string; points: number }[];
    debrief: string;
...
> = {
  ...
  phishing: {
    ...
    choices: [
      { id: "click", label: "Je clique sur le lien sans vérifier — c'est urgent.", outcome: "bad", feedback: "L'urgence est précisément le levier de manipulation des phishings. Toujours prendre 5 secondes.", points: 0 },
      { id: "verify", label: "Je vérifie l'expéditeur, je passe le curseur sur le lien sans cliquer, je signale si suspect.", outcome: "good", feedback: "Le bon réflexe en 3 étapes. Si doute : signaler à l'IT plutôt que cliquer.", points: 30 },
      { id: "ignore", label: "Je supprime sans rien faire.", outcome: "neutral", feedback: "Mieux que cliquer, mais signaler permet à l'IT de protéger les autres collègues.", points: 15 },
    ],
    debrief:
    ...
    quizExplanation: "La vérification de l'expéditeur réel + le signalement IT sont les 2 actions qui protègent la PME. Cliquer ou transférer largement = amplifier le risque.",
  },
  ...
  "mots-de-passe": {
    ...
    choices: [
      { id: "weak", label: "Je réutilise mon mot de passe perso, c'est plus simple.", outcome: "bad", feedback: "Si un service externe est compromis, tous vos comptes pro sont à risque. Jamais de réutilisation.", points: 0 },
      { id: "manager", label: "J'utilise un gestionnaire de mots de passe avec MFA activé.", outcome: "good", feedback: "Le combo gagnant : 1 mot de passe unique fort par service + MFA partout où possible.", points: 30 },
      { id: "postit", label: "Je note tout sur un post-it sous le clavier.", outcome: "bad", feedback: "Anyone passant à votre bureau a accès à tout. À éviter absolument.", points: 0 },
    ],
    debrief:
    ...
    quizExplanation: "Le gestionnaire + MFA résout les 2 problèmes : mémorisation et compromission. C'est la base recommandée par l'ANSSI.",
  },
  ...
  ransomware: {
    ...
    choices: [
      { id: "pay", label: "Je paye la rançon discrètement.", outcome: "bad", feedback: "Payer ne garantit pas la récupération et finance les attaquants. ANSSI recommande de NE JAMAIS payer.", points: 0 },
      { id: "isolate", label: "Je débranche le câble réseau et je préviens l'IT immédiatement.", outcome: "good", feedback: "Confinement immédiat sans éteindre le poste (préservation des preuves). Bon réflexe.", points: 30 },
      { id: "shutdown", label: "J'éteins le poste pour stopper l'attaque.", outcome: "neutral", feedback: "Mieux que rien, mais on perd la mémoire vive utile à l'analyse forensique. Préférer le débranchement réseau.", points: 15 },
    ],
    debrief:
    ...
    quizExplanation: "Le confinement réseau stoppe la propagation sans perdre les preuves mémoire. L'extinction supprime des éléments forensiques précieux.",
  },

  // ==== IA generative ====
  "ia-generative": {
    persona: "Vous êtes collaborateur PME utilisant ChatGPT/Mistral au quotidien",
    ...
    choices: [
      { id: "paste", label: "Je colle le document client en entier dans ChatGPT, c'est plus rapide.", outcome: "bad", feedback: "Les prompts sont mémorisés et peuvent être utilisés pour entraîner des modèles. Données client = JAMAIS dans une IA grand public.", points: 0 },
      { id: "anonymize", label: "Je remplace les noms et données sensibles par des placeholders avant de coller.", outcome: "good", feedback: "Bon réflexe d'anonymisation. Encore mieux : utiliser une IA souveraine type Mistral pour les données pro.", points: 30 },
      { id: "ignore", label: "Je n'utilise pas l'IA du tout, c'est trop risqué.", outcome: "neutral", feedback: "Prudent mais limitatif. L'IA est utilisable pour des cas non-sensibles, et il existe des alternatives souveraines.", points: 15 },
    ],
    debrief:
    ...
    quizCorrect: "Anonymiser les données avant de les coller, ou utiliser une IA souveraine",
    quizDistractors: [
      "Tout coller, l'IA est confidentielle",
      "Coller mais en anglais pour brouiller",
    ],
    quizExplanation: "L'anonymisation est la base. Les outils comme ChatGPT US peuvent servir pour des contenus génériques, mais pas pour des données client/RH.",
  },
  ...
  "nis2-pme": {
    ...
    choices: [
      { id: "ignore", label: "On verra plus tard, on n'a jamais été contrôlés.", outcome: "bad", feedback: "Les sanctions NIS2 vont jusqu'à 10 M€ ou 2 % du CA mondial. Et un incident peut déclencher un audit a posteriori.", points: 0 },
      { id: "act", label: "Je vérifie notre statut NIS2, je documente nos mesures et je nomme un référent cyber.", outcome: "good", feedback: "Les 3 actions clés. La documentation peut sauver une amende en cas d'incident.", points: 30 },
      { id: "delegate", label: "Je délègue à mon prestataire IT habituel sans suivre.", outcome: "neutral", feedback: "Délégation possible mais la responsabilité reste au dirigeant. Toujours vérifier ce qui est fait en votre nom.", points: 15 },
    ],
    debrief:
    ...
    quizCorrect: "Vérifier le statut NIS2 et documenter les mesures de sécurité",
    quizDistractors: [
      "Attendre d'être contrôlé pour agir",
      "Acheter une assurance et oublier",
    ],
    quizExplanation: "Vérification de statut + documentation = la base pour démontrer la diligence. Une assurance ne remplace pas la conformité.",
  },
  ...
  default: {
    ...
    choices: [
      { id: "rush", label: "J'agis immédiatement sans vérifier, je verrai après.", outcome: "bad", feedback: "L'urgence est rarement compatible avec la sécurité. Toujours prendre quelques secondes pour vérifier.", points: 0 },
      { id: "verify", label: "Je vérifie l'origine et la légitimité avant d'agir, je signale à l'IT si doute.", outcome: "good", feedback: "Bon réflexe. La vérification + le signalement protègent toute l'organisation.", points: 30 },
      { id: "ignore", label: "Je ferme et je passe à autre chose sans rien dire.", outcome: "neutral", feedback: "Mieux que rien, mais signaler permet à l'IT de prévenir les autres.", points: 15 },
    ],
    debrief:
    ...
    quizCorrect: "Vérifier l'origine, agir avec prudence, signaler à l'IT si doute",
    quizDistractors: [
      "Agir le plus vite possible",
      "Demander à un collègue, il saura forcément",
    ],
    quizExplanation: "Vérifier + signaler = la base. Demander aux collègues peut amplifier la confusion ou propager une attaque par ingénierie sociale.",
  },
};
...
export function buildFallbackContent(args: {
  ...
  const profil = CATEGORIE_PROFILS[args.saisonSlug] ?? CATEGORIE_PROFILS["default"];
