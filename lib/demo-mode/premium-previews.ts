...
export const PREMIUM_SAISONS_PREVIEW: PremiumSaisonPreview[] = [
  ...
  {
    slug: "voyages-affaires",
    title: "Voyages d'affaires : la cyber en mobilité",
    emoji: "✈️",
    audience: "voyageur",
    episodes: 6,
  },
  {
    slug: "enfants-numerique-famille",
    title: "Cyber-famille : protéger ses enfants",
    emoji: "👨‍👩‍👧‍👦",
    audience: "famille",
    episodes: 6,
  },
  {
    slug: "byod-perso-pro",
    title: "BYOD : la frontière vie pro / vie perso",
    emoji: "📱",
    audience: "tous",
    episodes: 6,
  },
...
export const PREMIUM_ARTICLES_PREVIEW: PremiumArticlePreview[] = [
  ...
  },
  {
    ...
    title: "Sécurité des jeux en ligne : Roblox, Fortnite, Minecraft",
    emoji: "🎮",
    category: "famille",
    audience: "famille",
  },
  ...
  },
  {
    ...
    title: "Sharenting : protéger les photos de vos enfants",
    emoji: "📸",
    category: "famille",
    audience: "famille",
  },
  ...
  {
    slug: "phishing-en-30-secondes",
    title: "Reconnaître un phishing en 30 secondes",
    emoji: "🎣",
    category: "phishing",
    audience: "pro",
  },
  {
    slug: "teletravail-securise-guide",
    title: "Le télétravail sécurisé, du salon au CODIR",
    emoji: "🏠",
    category: "teletravail",
    audience: "pro",
  },
  {
    slug: "ia-generative-au-boulot",
    title: "ChatGPT, Claude, Mistral au boulot : ce qu'il faut savoir",
    emoji: "🤖",
    category: "ia",
    audience: "pro",
  },
  {
    slug: "passwords-en-equipe",
    title: "Partager des mots de passe en équipe sans Excel",
    emoji: "🤝",
    category: "mots-de-passe",
    audience: "pro",
  },
  {
    slug: "rgpd-petite-pme",
    title: "Le RGPD pour une PME de 10 personnes",
    emoji: "📋",
    category: "rgpd",
    audience: "pro",
  },
  {
    slug: "emails-pro-2026",
    title: "Les bonnes pratiques email en 2026",
    emoji: "📧",
    category: "email",
    audience: "pro",
  },
  {
    slug: "sauvegardes-3-2-1",
    title: "La règle 3-2-1 des sauvegardes",
    emoji: "💾",
    category: "sauvegardes",
    audience: "tous",
  },
  {
    slug: "backup-smartphone-photos",
    title: "Ne perdez plus jamais les photos de votre smartphone",
    emoji: "📱",
    category: "sauvegardes",
    audience: "tous",
  },
  {
    slug: "faux-sav-microsoft",
    title: "Le faux SAV Microsoft (et autres call centers piégés)",
    emoji: "📞",
    category: "fraude",
    audience: "tous",
  },
  {
    slug: "sextorsion-que-faire",
    title: "Sextorsion : que faire si on est victime",
    emoji: "🚨",
    category: "fraude",
    audience: "tous",
  },
  {
    slug: "cyber-cabinet-medical",
    title: "Cyber-sécurité au cabinet médical",
    emoji: "⚕️",
    category: "metier-sante",
    audience: "pro",
  },
  {
    slug: "cyber-cabinet-avocat",
    title: "Cyber-sécurité au cabinet d'avocats",
    emoji: "⚖️",
    category: "metier-juridique",
    audience: "pro",
  },
  {
    slug: "cyber-collectivite-mairie",
    title: "Cyber-sécurité en collectivité territoriale",
    emoji: "🏛",
    category: "metier-public",
    audience: "pro",
  },
  {
    slug: "discord-twitch-enfants",
    title: "Discord et Twitch : protéger ses enfants",
    emoji: "🎮",
    category: "famille",
    audience: "famille",
  },
  {
    ...
    title: "Préparer sa succession numérique",
    emoji: "🕊️",
    category: "famille",
    audience: "famille",
  },
  {
    slug: "phishing-vocal-vishing",
    title: "Vishing : l'arnaque téléphonique nouvelle génération",
    emoji: "📞",
    category: "fraude",
    audience: "tous",
  },
...
export const PREMIUM_INVESTIGATIONS_PREVIEW: PremiumInvestigationPreview[] = [
  {
    slug: "email-banque-bnp-alerte",
    title: "Le SMS d'alerte de ta « banque »",
    difficulty: 3,
  },
  {
    slug: "email-fournisseur-changement-iban",
    title: "L'email du fournisseur qui change d'IBAN",
    difficulty: 4,
  },
  {
    slug: "email-fournisseur-rib",
    title: "Le changement d'IBAN du fournisseur électricité",
    difficulty: 4,
  },
  {
    slug: "email-livreur-douane",
    title: "Le colis Colissimo bloqué en douane",
    difficulty: 2,
  },
  {
    slug: "email-office365-licence-expiration",
    title: "L'email Office 365 d'expiration de licence",
    difficulty: 2,
  },
  {
    slug: "email-recouvrement-cabinet-avocat",
    title: "L'email du cabinet d'avocats pour facture impayée",
    difficulty: 4,
  },
  {
    slug: "email-rh-bulletin-paie",
    title: "Le mail RH « bulletin de paie en attente »",
    difficulty: 3,
  },
  {
    slug: "email-rh-prime-fin-annee",
    title: "L'email RH de prime exceptionnelle de fin d'année",
    difficulty: 3,
  },
  {
    slug: "facebook-anniversaire-enfant",
    title: "Le post Facebook pour l'anniversaire de Léo",
    difficulty: 3,
  },
  {
    slug: "facebook-test-quel-personnage",
    title: "Le test Facebook « Quel personnage de One Piece es-tu ? »",
    difficulty: 2,
  },
  {
    slug: "facebook-vacances-creteois",
    title: "Le post Facebook des vacances en Crête",
    difficulty: 2,
  },
  {
    slug: "linkedin-ancien-camarade-promo",
    title: "L'ancien camarade de promo qui réapparaît",
    difficulty: 4,
  },
  {
    slug: "linkedin-cv-leak",
    title: "Le post LinkedIn de recherche d'emploi",
    difficulty: 3,
  },
  {
    slug: "linkedin-recruteur-cabinet-prestige",
    title: "Le recruteur LinkedIn d'un cabinet prestigieux",
    difficulty: 3,
  },
  {
    slug: "linkedin-stage-rentree",
    title: "Le post LinkedIn du stagiaire enthousiaste",
    difficulty: 4,
  },
  {
    slug: "photo-piggyback-parking-garage",
    title: "Le parking garage avec barrière automatique",
    difficulty: 3,
  },
  {
    slug: "photo-piggyback-sas",
    title: "Le sas d'entrée du matin",
    difficulty: 3,
  },
  {
    slug: "photo-salle-reunion-whiteboard",
    title: "La salle de réunion juste après le COMEX",
    difficulty: 4,
  },
  {
    slug: "photo-trash-bin",
    title: "La poubelle commune de l'open-space",
    difficulty: 3,
  },
  {
    slug: "public-wifi-hotspot-conference",
    title: "Le hotspot Wi-Fi de la salle de conférence",
    difficulty: 4,
  },
  {
    slug: "sms-vinted-livraison-bloquee",
    title: "Le SMS Vinted de livraison bloquée",
    difficulty: 2,
  },
  {
    slug: "sms-banque-blocage",
    title: "Le SMS bancaire de blocage immédiat",
    difficulty: 2,
  },
  {
    slug: "sms-cnam-remboursement-soin",
    title: "Le SMS CNAM de remboursement de soin",
    difficulty: 2,
  },
  {
    slug: "sms-impots-remboursement",
    title: "Le SMS de remboursement des impôts",
    difficulty: 2,
  },
];
