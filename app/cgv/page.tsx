...
import LegalLayout, { LegalSection, LegalSubsection, LegalHighlight } from "@/components/legal/LegalLayout";

export const metadata = {
  title: "CGV — Conditions Générales de Vente — Humanix-Cybersecurity",
  description: "CGV B2B applicables aux prestations Humanix-Cybersecurity (SaaS, formation, audit).",
};
  ...
  return (
    ...
    >
      <LegalHighlight variant="warning">
        Les présentes CGV s'appliquent aux relations <strong>B2B</strong> entre professionnels. Trois types de prestations sont couverts : (a) abonnement à la plateforme Humanix Académie ; (b) formation professionnelle ; (c) prestations d'audit et de conseil en cybersécurité.
      </LegalHighlight>

      <LegalSection id="objet" num="Article 1" title="Objet et identification du prestataire">
        <p>
          Les présentes Conditions Générales de Vente (ci-après <strong>« CGV »</strong>) régissent les relations contractuelles entre :
        </p>
        <ul>
          <li>
            <strong>Humanix-Cybersecurity</strong>, SASU au capital de 100 € — siège social 16 Rue Joseph Loiret, 30100 Alès — RCS Nîmes 103 901 799 — TVA FR 80 103 901 799 (ci-après <strong>« Humanix-Cybersecurity »</strong> ou <strong>« le Prestataire »</strong>),
          </li>
          <li>et toute personne morale, professionnelle, commandant une prestation auprès de Humanix-Cybersecurity (ci-après <strong>« le Client »</strong>).</li>
        </ul>
        <p>
      ...
      <LegalSection id="prestations" num="Article 2" title="Prestations proposées">
        <LegalSubsection num="2.1" title="Plateforme Humanix Académie (mode SaaS)">
          <p>
            Humanix-Cybersecurity met à disposition du Client la plateforme web <strong>Humanix Académie</strong> (par Humanix-Cybersecurity), accessible en mode <strong>SaaS</strong>. L'accès est consenti pour la durée d'abonnement souscrite, dans la limite du nombre de licences (sièges) commandées et selon les fonctionnalités du palier choisi (Découverte, Starter, Essentielle, Pro, Enterprise). Le palier Découverte est mis à disposition gracieusement, sans engagement, dans la limite de cinq (5) licences.
          </p>
        </LegalSubsection>

        <LegalSubsection num="2.1bis" title="Plateforme Humanix Community Edition (self-host)">
          <p>
            Humanix-Cybersecurity met également à disposition, sous licence libre <strong>GNU AGPLv3</strong>, le code source de la plateforme sous l'appellation <strong>Humanix Community Edition</strong>. Cette mise à disposition gracieuse est régie par les termes de la licence AGPLv3 (consultable sur <a href="https://www.gnu.org/licenses/agpl-3.0.html" rel="noreferrer">gnu.org</a>) et ne fait l'objet d'aucune garantie commerciale par Humanix-Cybersecurity. Le Client qui choisit le mode self-host est seul responsable de l'installation, l'exploitation, la maintenance et la sécurité de son instance.
          </p>
        </LegalSubsection>
        ...
        <LegalSubsection num="2.4" title="Connecteurs et intégrations">
          <p>
            La plateforme Humanix Académie expose, à partir de l'offre Essentielle, un endpoint d'export de preuves de conformité (<code>/api/v1/evidence-export</code>) compatible avec plusieurs formats standards : <strong>OSCAL v1.1.2</strong> (NIST), <strong>Splunk CIM v1</strong>, <strong>ArcSight CEF v1</strong>, ainsi qu'un format propre à <strong>CISO Assistant</strong>. Un endpoint <strong>SCIM v2</strong> (RFC 7643/7644) est également exposé pour le provisioning automatique d'utilisateurs depuis l'annuaire du Client. Des webhooks signés HMAC-SHA256 permettent la notification temps réel d'événements.
          </p>
          <p>
            Des connecteurs Python autonomes (CISO Assistant, Splunk HEC, Microsoft Sentinel) sont fournis sous licence MIT et sont utilisables librement par le Client. Humanix-Cybersecurity s'engage à maintenir ces connecteurs à jour avec la version courante de son API, mais <strong>ne fournit pas de support sur les outils tiers</strong> (CISO Assistant, Splunk, Sentinel, etc.) ni sur leur exploitation interne par le Client. Le bon fonctionnement de ces outils tiers relève de la seule responsabilité du Client et de leurs éditeurs respectifs.
          </p>
          <p>
            Tout connecteur sur-mesure pour un outil non couvert par la liste des intégrations natives publiées sur <Link href="/integrations">/integrations</Link> fait l'objet d'une prestation séparée, facturée selon le contrat de mission spécifique mentionné en 2.3.
          </p>
        </LegalSubsection>
      </LegalSection>

      <LegalSection id="commande" num="Article 3" title="Commande et formation du contrat">
        <p>
      ...
      <LegalSection id="tarifs" num="Article 4" title="Tarifs et modalités de paiement">
        <p>
        ...
        <p>
          <strong>Modalités de paiement</strong> : par virement bancaire ou prélèvement SEPA, à 30 jours nets date de facture. Pour les abonnements SaaS, paiement à la souscription puis selon la périodicité convenue (mensuelle ou annuelle).
        </p>
        <LegalHighlight variant="warning">
          <strong>Pénalités de retard</strong> : conformément à l'article L441-10 du Code de commerce, tout retard de paiement entraîne de plein droit l'application de pénalités au taux de la BCE majoré de 10 points, ainsi qu'une indemnité forfaitaire pour frais de recouvrement de 40 €.
        </LegalHighlight>
      </LegalSection>
      ...
      <LegalSection id="duree" num="Article 5" title="Durée et résiliation">
        <LegalSubsection num="5.1" title="Plateforme SaaS">
          <p>
            L'abonnement est conclu pour la durée indiquée dans le devis (mensuelle ou annuelle). Il est renouvelé tacitement par périodes de même durée, sauf dénonciation par l'une ou l'autre partie au moins 30 jours avant l'échéance, par email à <a href="mailto:contact@humanix-cybersecurity.fr">contact@humanix-cybersecurity.fr</a> ou par lettre recommandée. Pour les contrats B2B, la durée d'engagement initial ne peut excéder 24 mois.
          </p>
        </LegalSubsection>
      ...
      <LegalSection id="sla" num="Article 6" title="Disponibilité du service SaaS (SLA)">
        <p>
          Humanix-Cybersecurity s'engage à mettre en œuvre les moyens raisonnables pour assurer une disponibilité de la plateforme Humanix Académie d'<strong>au moins 99 % en moyenne mensuelle</strong>, hors :
        </p>
        <ul>
          <li>Maintenances planifiées annoncées au moins 48h à l'avance ;</li>
          <li>Cas de force majeure (article 7) ;</li>
          <li>Indisponibilités imputables à l'hébergeur (Scaleway) ou au fournisseur de connectivité ;</li>
          <li>Indisponibilités imputables au Client ou à ses utilisateurs.</li>
        </ul>
        <p>
          Tout incident est signalé via <a href="mailto:support@humanix-cybersecurity.fr">support@humanix-cybersecurity.fr</a>.
        </p>
        <p>
      ...
      <LegalSection id="ip" num="Article 8" title="Propriété intellectuelle">
        <p>
          Tous les contenus, modules, scénarios pédagogiques, mascottes, code source de la plateforme Humanix Académie demeurent la propriété exclusive de Humanix-Cybersecurity. Le Client se voit concéder un <strong>droit d'usage non exclusif, non cessible et non transférable</strong>, limité à la durée de l'abonnement et au nombre de licences souscrites, à des fins de formation interne uniquement.
        </p>
        <p>
      ...
      <LegalSection id="rgpd" num="Article 9" title="Données personnelles et confidentialité">
        <p>
          Pour les prestations SaaS, Humanix-Cybersecurity agit en qualité de <strong>sous-traitant</strong> au sens de l'article 28 du RGPD, pour le compte du Client responsable du traitement.
        </p>
        <LegalHighlight variant="info">
          Un <strong>contrat de sous-traitance (DPA)</strong> conforme au RGPD art. 28 et aux Clauses Contractuelles Types de la Commission européenne (décision 2021/914) est transmis au Client avant toute mise en service de la plateforme. Sans DPA signé, la prestation SaaS ne peut être activée. Un modèle peut être obtenu sur demande à <a href="mailto:contact@humanix-cybersecurity.fr">contact@humanix-cybersecurity.fr</a>.
        </LegalHighlight>
        <p>
        ...
        <p>
          Cf. notre <Link href="/confidentialite">politique de confidentialité</Link> pour le détail des traitements et de leur durée.
        </p>
      </LegalSection>

      <LegalSection id="responsabilite" num="Article 10" title="Responsabilité">
        <p>
          Humanix-Cybersecurity est tenue d'une <strong>obligation de moyens</strong> dans l'exécution de ses prestations. Sa responsabilité contractuelle est limitée aux dommages directs prouvés.
        </p>
        <p>
          Le plafond de responsabilité contractuelle, par sinistre et par année civile, est fixé au montant total des sommes versées par le Client au titre du contrat concerné au cours des <strong>douze (12) derniers mois</strong>. Cette limitation s'entend sans préjudice :
        </p>
        <ul>
          <li>de la garantie effectivement couverte par la police d'assurance Responsabilité Civile Professionnelle (cf. infra), qui peut être actionnée au-delà du plafond contractuel ;</li>
          <li>des cas d'exclusion légale des plafonds : faute lourde, faute intentionnelle, dol, atteinte aux droits fondamentaux de la personne ou violation intentionnelle des obligations de confidentialité.</li>
        </ul>
        <p>
        ...
        <LegalHighlight variant="success">
          Humanix-Cybersecurity dispose d'une assurance Responsabilité Civile Professionnelle adaptée à son activité de cybersécurité (audit, conseil, SaaS). Les coordonnées de l'assureur et le numéro de police peuvent être communiqués sur demande écrite à <a href="mailto:contact@humanix-cybersecurity.fr">contact@humanix-cybersecurity.fr</a>, et figurent dans le contrat de mission le cas échéant.
        </LegalHighlight>
      </LegalSection>

      <LegalSection id="audit" num="Article 11" title="Cadre spécifique aux prestations d'audit / pentest">
        <LegalHighlight variant="warning">
          Les missions de tests d'intrusion ne peuvent être réalisées qu'après signature préalable et concomitante :
          <ul className="mt-2">
            <li>d'une <strong>convention de service ou lettre de mission</strong> précisant le périmètre exact, la fenêtre temporelle, les méthodes autorisées et le contact d'urgence ;</li>
            <li>d'un <strong>accord de confidentialité (NDA)</strong> protégeant les vulnérabilités, identifiants et configurations découverts.</li>
          </ul>
      ...
      <LegalSection id="formation" num="Article 12" title="Cadre spécifique aux prestations de formation">
        <p>
        ...
        <LegalHighlight variant="info">
          <strong>Numéro de déclaration d'activité de formation</strong> : [À COMPLÉTER après enregistrement DREETS Occitanie]<br />
          <strong>Statut Qualiopi</strong> : non certifié à ce jour. Démarche envisagée à venir.<br />
      ...
      <LegalSection id="soustraitance" num="Article 13" title="Sous-traitance">
        <p>
          Humanix-Cybersecurity recourt à des sous-traitants techniques pour l'exécution de ses prestations. La liste à jour est consultable sur la page <Link href="/securite">Sécurité &amp; Conformité</Link>. Au jour des présentes CGV, ces sous-traitants sont :
        </p>
        <ul>
          <li><strong>Scaleway SAS</strong> (France) — hébergement, sauvegardes, infrastructure ;</li>
          <li><strong>Olinda SAS / Qonto</strong> (France) — compte de paiement professionnel ;</li>
          <li><strong>Dougs SAS</strong> (France) — expertise comptable et facturation ;</li>
          <li><strong>Resend</strong> (UE, clauses contractuelles types) — emails transactionnels (lien magique de connexion, alertes système).</li>
        </ul>
        <p>
      ...
      <LegalSection id="confidentialite" num="Article 14" title="Confidentialité">
        <p>
      ...
      <LegalSection id="reference" num="Article 15" title="Référencement commercial">
        <p>
      ...
      <LegalSection id="droit" num="Article 16" title="Loi applicable et juridiction">
        <p>
          Les présentes CGV sont régies par le droit français. Tout litige relatif à leur interprétation ou leur exécution, à défaut de résolution amiable, relève de la compétence exclusive du <strong>Tribunal de commerce de Nîmes</strong>.
        </p>
      </LegalSection>

      <LegalSection id="modifications" num="Article 17" title="Modifications des CGV">
        <p>
