      ...
      {saisons.length === 0 ? (
        <div className="card text-center py-16">
          ...
          <p className="text-gray-500 mb-2">
            Aucun module n'est actif pour ton entreprise.
          </p>
          <p className="text-sm text-gray-400">
            Demande à ton dirigeant de t'activer un module.
          </p>
        </div>
      ) : (
        <>
            ...
            {saisons.map((s, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h2 className="font-bold text-primary-500 text-lg mb-1">
                    {s.title}
                  </h2>
                  ...
                  {isLocked ? (
                    ...
                    <Link
                      href={`/apprendre/${s.slug}/${firstUndone.slug}`}
        ...
        <div className="card bg-gradient-to-br from-amber-50 to-white border-amber-200">
          <div className="flex flex-wrap gap-3">
            ...
            {completedCount >= totalEpisodes && totalEpisodes > 0 && (
              <Badge emoji="👑" label="Toutes saisons" />
            )}
            ...
            {(user?.shareCount ?? 0) >= 1 && (
              <Badge emoji="📤" label="Partageur" />
            )}
            {(user?.shareCount ?? 0) >= 3 && (
              <Badge emoji="🎖️" label="Ambassadeur" />
            )}
            {(user?.shareCount ?? 0) >= 10 && (
              <Badge emoji="🌟" label="Évangéliste cyber" />
            )}
            {completedCount === 0 && (
...
function MiniStat({
  ...
  return (
    <div className="bg-white/70 rounded-xl p-2 text-center">
      ...
      <p className="text-base sm:text-lg font-extrabold text-primary-500">
        {value}
      </p>
