...
export default function CybermalveillanceIntegrationPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 sm:py-14 animate-fadeIn">
      ...
      >
        <h2 id="urgence-title" className="text-xl font-extrabold text-red-700 dark:text-red-300 mb-2">
          En cas d'incident cyber avéré
        </h2>
        <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">
          Si vous (ou un de vos collaborateurs) êtes victime d'une attaque (rançongiciel, fraude, fuite de données…) :
        </p>
        <ol className="space-y-2 text-sm list-decimal list-inside">
          ...
          <li>Suivez le diagnostic guidé (5 min) — il oriente vers les bons réflexes.</li>
          <li>Si nécessaire, vous êtes mis en relation avec un prestataire labellisé <strong>ExpertCyber</strong>.</li>
          <li>Déposez plainte auprès de la police ou gendarmerie (procédure dans le diagnostic).</li>
        </ol>
      </section>

      {/* Comment Humanix s'articule */}
      <section aria-labelledby="lien-title" className="mb-10">
        <h2 id="lien-title" className="text-2xl font-extrabold text-primary-500 mb-3">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <article className="card">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              ...
              dans la <Link href="/librairie" className="font-bold underline">librairie Humanix</Link>{" "}
          ...
          <article className="card">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              La <Link href="/admin/incidents" className="font-bold underline">procédure incident</Link>{" "}
          ...
          <article className="card">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Notre <Link href="/anecdotes" className="font-bold underline">cyber-anecdote du lundi</Link>{" "}
              relaie chaque mois une alerte officielle CyberMalveillance auprès des
              dirigeants PME abonnés.
            </p>
          </article>
          ...
          <article className="card">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Humanix-Cybersecurity a déposé un dossier de référencement auprès du
              GIP ACYMA, opérateur de CyberMalveillance.gouv.fr. Statut :
              <strong> en cours d'instruction</strong>. Mise à jour à publication.
            </p>
          </article>
        </div>
      </section>
      ...
      <section aria-labelledby="ressources-title" className="mb-10">
        <h2 id="ressources-title" className="text-2xl font-extrabold text-primary-500 mb-3">
          Ressources officielles
        </h2>
        <ul className="space-y-2 text-sm">
          <li>
            <a href="https://www.cybermalveillance.gouv.fr/" target="_blank" rel="noopener noreferrer" className="font-bold text-accent-500 hover:underline">
              cybermalveillance.gouv.fr ↗
            </a>
            {" "}— site officiel
          </li>
          <li>
            <a href="https://www.cybermalveillance.gouv.fr/diagnostic" target="_blank" rel="noopener noreferrer" className="font-bold text-accent-500 hover:underline">
              Diagnostic guidé ↗
            </a>
            {" "}— premier réflexe en cas d'incident
          </li>
          <li>
            <a href="https://www.cybermalveillance.gouv.fr/tous-nos-contenus" target="_blank" rel="noopener noreferrer" className="font-bold text-accent-500 hover:underline">
              Bibliothèque officielle ↗
            </a>
            {" "}— fiches gratuites par thème
          </li>
          <li>
            <a href="https://www.cybermalveillance.gouv.fr/expertcyber" target="_blank" rel="noopener noreferrer" className="font-bold text-accent-500 hover:underline">
              Label ExpertCyber ↗
            </a>
      ...
      <section className="card text-center bg-gradient-to-br from-primary-500 to-accent-500 text-white">
        <h2 className="text-2xl font-extrabold mb-2">L'État vous protège, Humanix vous prépare 🇫🇷</h2>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link href="/librairie" className="bg-white text-primary-500 font-bold px-6 py-3 rounded-2xl hover:scale-105 transition shadow-lg">
            Voir la librairie
          </Link>
