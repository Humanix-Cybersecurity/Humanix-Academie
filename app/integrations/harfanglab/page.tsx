    ...
    <div className="max-w-5xl mx-auto px-4 py-10 sm:py-14 animate-fadeIn">
      <header className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          Votre EDR détecte → Humanix forme → le risque résiduel diminue → l'EDR détecte moins → vos collaborateurs sont vraiment protégés.
        </p>
      </header>

      <section aria-labelledby="loop-title" className="mb-10">
        <h2 id="loop-title" className="text-2xl font-extrabold text-primary-500 mb-4">
        ...
        >
          ...
          <text x="170" y="78" textAnchor="middle" fontSize="13" fontWeight="800" fill="white">HarfangLab</text>
          <text x="170" y="95" textAnchor="middle" fontSize="11" fill="white" opacity="0.85">détecte</text>

          <circle cx="530" cy="80" r="55" fill="url(#gh-fr)" />
          <text x="530" y="78" textAnchor="middle" fontSize="13" fontWeight="800" fill="white">Humanix</text>
          <text x="530" y="95" textAnchor="middle" fontSize="11" fill="white" opacity="0.85">forme cible</text>

          <circle cx="170" cy="240" r="55" fill="url(#gh-fr)" />
          <text x="170" y="238" textAnchor="middle" fontSize="13" fontWeight="800" fill="white">Risque</text>
          <text x="170" y="255" textAnchor="middle" fontSize="11" fill="white" opacity="0.85">diminue</text>

          <circle cx="530" cy="240" r="55" fill="url(#gh-fr)" />
          <text x="530" y="238" textAnchor="middle" fontSize="13" fontWeight="800" fill="white">User</text>
          <text x="530" y="255" textAnchor="middle" fontSize="11" fill="white" opacity="0.85">apprend</text>

          <line x1="225" y1="80" x2="475" y2="80" stroke="#00A3A1" strokeWidth="2.5" markerEnd="url(#arrowH)" />
          <line x1="530" y1="135" x2="530" y2="185" stroke="#00A3A1" strokeWidth="2.5" markerEnd="url(#arrowH)" />
          <line x1="475" y1="240" x2="225" y2="240" stroke="#00A3A1" strokeWidth="2.5" markerEnd="url(#arrowH)" />
          <line x1="170" y1="185" x2="170" y2="135" stroke="#00A3A1" strokeWidth="2.5" markerEnd="url(#arrowH)" />

          <text x="350" y="68" textAnchor="middle" fontSize="11" fill="#555" fontWeight="700">alertes EDR</text>
          <text x="556" y="165" textAnchor="middle" fontSize="11" fill="#555" fontWeight="700">campagne</text>
          <text x="350" y="228" textAnchor="middle" fontSize="11" fill="#555" fontWeight="700">moins de risques</text>
          <text x="148" y="165" textAnchor="middle" fontSize="11" fill="#555" fontWeight="700">moins de bruit</text>
        </svg>
      </section>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <article className="card">
            ...
            <pre className="text-xs bg-slate-900 dark:bg-black text-slate-100 p-3 rounded-lg overflow-x-auto">
              <code>python humanix_harfanglab_connector.py push --framework NIS2</code>
            </pre>
      ...
      <section className="card text-center bg-gradient-to-br from-primary-500 to-accent-500 text-white">
        <h2 className="text-2xl font-extrabold mb-2">EDR + Sensibilisation : la combinaison souveraine 🇫🇷</h2>
