    ...
    <div className="max-w-4xl mx-auto px-4 py-10 sm:py-14 animate-fadeIn">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          engagements et les preuves derrière, en transparence.
        </p>
      </div>
        ...
        <div className="grid sm:grid-cols-[auto_1fr_auto] gap-5 items-center">
          ...
          <div>
            ...
            <p className="text-sm opacity-90 mt-1">
              Méthodologie OWASP/ANSSI, contrôles vérifiés, gaps assumés, plan
              de remédiation à 6 mois. PDF d'une douzaine de pages, public,
              daté, signé.
            </p>
          </div>
          <Link
      ...
      <Section emoji="🇫🇷" title="Hébergement souverain en France">
        <p>
          ...
          Iliad. Datacenters en région parisienne, opérateur de droit français,
      ...
      <Section emoji="📋" title="Conformité RGPD">
        <ul>
          <li>
            <strong>Politique de confidentialité</strong> détaillée : durées de
            conservation, droits, sous-traitants →{" "}
            <Link href="/confidentialite">la consulter</Link>
          </li>
          <li>
            <strong>Contrat de sous-traitance (DPA)</strong> systématiquement
            signé avec chaque client SaaS — modèle aligné sur les clauses types
            CNIL
          </li>
          <li>
          ...
          <li>
            <strong>Mesures de minimisation</strong> : nous ne collectons que ce
            qui est nécessaire à la finalité pédagogique
          </li>
        </ul>
      </Section>
      ...
      <Section emoji="🔐" title="Sécurité technique de la plateforme">
        <ul>
          ...
          <li>
            <strong>Cloisonnement multi-tenant</strong> : isolation logique par{" "}
            <code>tenantId</code> sur toutes les requêtes, vérifié par tests
            automatisés
          </li>
          <li>
      ...
      <Section emoji="🤝" title="Sous-traitants techniques">
        ...
        <table className="w-full text-sm border border-gray-200 dark:border-slate-700 mt-2">
          ...
          <tbody>
            <tr>
              <td className="border p-2">Scaleway SAS</td>
              <td className="border p-2">Hébergement</td>
              <td className="border p-2">France 🇫🇷</td>
            </tr>
            <tr>
              <td className="border p-2">Olinda SAS (Qonto)</td>
              <td className="border p-2">Compte de paiement</td>
              <td className="border p-2">France 🇫🇷</td>
            </tr>
            <tr>
              <td className="border p-2">Dougs SAS</td>
              <td className="border p-2">Expertise comptable</td>
              <td className="border p-2">France 🇫🇷</td>
            </tr>
            <tr>
              <td className="border p-2">Resend</td>
              <td className="border p-2">
                Emails transactionnels (magic links)
              </td>
              <td className="border p-2">
                UE / fournisseur engageant des clauses types
              </td>
            </tr>
          </tbody>
        </table>
        <p className="text-xs text-gray-500 mt-2">
          ...
          l'objet d'une notification écrite aux clients, avec droit d'objection.
        </p>
      </Section>
      ...
      <Section emoji="🔄" title="Continuité de service">
        <ul>
          <li>
            <strong>SLA cible</strong> : 99 % de disponibilité mensuelle moyenne
          </li>
          <li>
          ...
          <li>
            <strong>Réversibilité</strong> : export des données au format CSV ou
            JSON sur simple demande, à tout moment
          </li>
        </ul>
      </Section>
      ...
      <Section emoji="👤" title="Engagement humain">
        <ul>
          ...
          <li>
            <strong>Ouverture aux audits</strong> : les clients peuvent réaliser
            leur propre audit sécurité, sur engagement écrit préalable
          </li>
        </ul>
      </Section>
      ...
      <Section emoji="🗺️" title="Roadmap conformité">
        <ul>
          ...
          <li>
            ...
            (Forgejo auto-hébergé chez Scaleway, ou plateforme communautaire FR
            équivalente). GitHub reste utilisé en attendant pour la visibilité
            écosystème open source — la portabilité est garantie par Git
            lui-même.
          </li>
          <li>
          ...
          <li>
            Conformité <strong>NIS2</strong> : application du référentiel ANSSI
            dès que applicable au volume d'activité
          </li>
        </ul>
      </Section>
      ...
      <Section emoji="🔗" title="Intégration GRC native">
        <p>
          Vos preuves de sensibilisation alimentent automatiquement votre outil
          GRC via l'API <code>/api/v1/evidence-export</code>. Connecteur Python
          prêt à l'emploi pour <strong>CISO Assistant</strong> (intuitem).
          Mappings ISO 27001, NIS2, RGPD, ANSSI HG documentés et auditables.
        </p>
        <p className="mt-3">
          <Link
      ...
      <p className="text-center text-xs text-gray-500 mt-10">
        Cette page reflète notre état au{" "}
        {new Date().toLocaleDateString("fr-FR")}. Mise à jour à chaque évolution
        majeure.
      </p>
    </div>
  );
