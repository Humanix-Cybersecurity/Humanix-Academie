        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          <div>
            ...
            <p className="text-sm text-red-700 dark:text-red-300">
              Démarrez le workflow guidé maintenant. Il vous accompagne sur les
              actions des 72 prochaines heures (confinement, notification CNIL/ANSSI,
              communication).
            </p>
          </div>
          <Link
      ...
      {incidents.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
            C'est une bonne nouvelle. Mais préparez-vous : 60 % des PME subiront
            un incident dans les 12 prochains mois.
          </p>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-slate-800">
              <tr className="text-left text-xs uppercase text-gray-500 dark:text-gray-400">
                ...
                <th scope="col" className="px-4 py-3">Détecté le</th>
                <th scope="col" className="px-4 py-3 text-right">Progression</th>
              </tr>
            </thead>
            <tbody>
              {incidents.map((i) => {
