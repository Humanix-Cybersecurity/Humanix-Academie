...
export default async function PhishingGenererPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">
        Mistral (IA française souveraine) crée un faux mail de phishing
      ...
      <div className="card mb-6 bg-gradient-to-br from-primary-50 to-cyan-50 dark:from-primary-900/30 dark:to-cyan-900/30 border-l-4 border-accent-500">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          Mistral AI est une entreprise française basée à Paris. Vos prompts
          ne quittent pas l'Union européenne. Compatibilité RGPD native, pas
          de Cloud Act US, et c'est tout aussi performant pour ce besoin.
          C'est notre choix de souveraineté.
        </p>
      </div>
      ...
      <div className="card mt-8 text-xs text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-slate-800">
        ...
        <p className="mb-2">
          La simulation de phishing en interne est <strong>légale et
          recommandée par l'ANSSI</strong> dans le cadre d'une démarche de
          sensibilisation cyber documentée. Pour rester dans les clous :
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>Information préalable des collaborateurs (charte cyber, voir Pack NIS2)</li>
          <li>Pas de sanction individuelle suite à un clic — uniquement formation</li>
          <li>Données de résultat anonymisables sur demande (cf. CSE)</li>
          <li>Le mail généré est SIMULÉ : pas de vrai payload, pas de domaine actif (extensions .example/.test)</li>
        </ul>
      </div>
    </div>
  );
