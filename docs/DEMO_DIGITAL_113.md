...
- [ ] Tenant demo `tenant-demo` initialise avec les 7 utilisateurs fixtures (cf. `prisma/seed-tenant-demo.ts`)
...
**Repli** :
1. Avoir un screencast 90 s pre-enregistre dans `docs/demo-assets/screencast-demo-fallback.mp4`.
...
- [ ] Importer dans HubSpot / pipedrive avec source `demo-runbook-2026`
