# Demo assets — Digital 113 (21 mai 2026)
...
| `screencast-d113-fallback.mp4` | Screencast 90 s pre-enregistre du flow demo complet | Si Next.js plante ou que docker-compose se prend les pieds |
...
A faire au moins 48 h avant Digital 113 :

1. Tenant demo `tenant-d113` initialise avec donnees fixtures
