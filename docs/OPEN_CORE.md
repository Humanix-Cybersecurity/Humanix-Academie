...
| **Client self-host Enterprise** | (cas spécifique)                                 | Contrat + licence Ed25519 → accès au content-pro via submodule, tarball signé ou image Docker (cf. section _Obtenir le content-pro_) |
